...
from Game import Game, colorSentence
...
print("="*20 + f" Placement Round: {player1.name}'s round " + "="*20)
...
while True:
    ...
    if (player1_name == player2_name):
        ...
        print("=" * 20 + f" Placement Round: {player2.name}'s round " + "=" * 20)
...
while True:
    ...
    if endGame == "endGame":
        print(colorSentence(f"{player1.name} win!"))
        break
    ...
    if endGame == "endGame":
        print(colorSentence(f"{player2.name} win!"))
        break
